...
public class SettingsCommand implements Command, ButtonCommand {
    ...
    public static void setup() {
        ...
        descriptionMap.put(Settings.Setting.MusicRole, "Using this seeting you can set a role so only users with that role can control the music (e.g. change station, volume, etc.).");
